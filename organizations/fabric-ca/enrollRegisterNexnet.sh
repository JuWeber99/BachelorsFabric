function createNexnet {
  ...
  echo
	printSubtask "Enroll the CA admin for nexnet"
  echo
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  echo
  printSubtask "Register user: nexnetuser"
  echo
  set -x
  ...
  echo
  printSubtask "Register the organisation admin for nexnet"
  echo
  set -x
  ...
  echo
  printSubtask "Generate the peer0 msp for nexnet"
  echo
  set -x
  ...
  echo
  printSubtask "Generate the peer0-tls certificates for nexnet"
  echo
  set -x
  ...
  echo
  printSubtask "Generate the user msp for nexnetuser-user"
  echo
  set -x
  ...
  echo
  printSubtask "Generate the nexnet admin msp"
  echo
  set -x
